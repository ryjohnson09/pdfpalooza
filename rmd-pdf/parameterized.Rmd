...
params:
  ...
  country_focus:
    ...
    value: United States
    input: select
    choices: !r unique(gapminder::gapminder$country)
title: "`r params$country_focus`"
---
...
In @ref(fig:fig-life-expectancy), we can view the life expectancy of `r params$country_focus` compared to every other country in the gapminder dataset.
...
In @ref(fig:fig-population), we can view the population of `r params$country_focus` compared to every other country in the gapminder dataset.
...
In @ref(fig:fig-gdp), we can view the population of `r params$country_focus` compared to every other country in the gapminder dataset.
